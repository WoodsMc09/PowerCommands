...
//Custom .yml configuration file (commandmanager/commands.yml)
    ...
    public void reloadConfig(){
        ...
        if(this.configFile == null){
            //create config file
            this.configFile = new File(this.pC.getDataFolder(), "commandmanager/actions.yml");
        }
        //set configuration instance to YamlConfiguration
        this.configuration = YamlConfiguration.loadConfiguration(this.configFile);

        //get input stream
        InputStream defaultStream = this.pC.getResource("commandmanager/actions.yml");
    ...
    public void saveDefaultConfig() {
        ...
        if (this.configFile == null) {
            ...
            //set config file
            this.configFile = new File(pC.getDataFolder(), "commandmanager/actions.yml");
        }
        ...
        if(!this.configFile.exists()){
            ...
            //save config
            pC.saveResource("commandmanager/actions.yml", false);
        }
    }
}
